...
from hana.rindou.nn2.conv import Conv7Block, DownsampleBlock, UpsampleBlock
...
class EncoderDecoderModule(Module):
    def __init__(self,
        ...
        while current_size > bottleneck_image_size:
            self.module_list.append(DownsampleBlock(current_channels, current_channels * 2, initialization_method))
            current_size //= 2
            current_channels *= 2
